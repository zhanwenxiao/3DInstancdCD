...
from torch_points3d.metrics.ahnicd_tracker import ahniCDTracker
...
AHNCD_CHANGE_CLASSES = 2
change_viridis = cm.get_cmap('viridis', AHNCD_CHANGE_CLASSES)
...
AHNCD_SEM_CLASSES = 2
sem_viridis = cm.get_cmap('viridis', AHNCD_CHANGE_CLASSES)
...
class AHNCDSimul(Dataset):
    ...
    def __init__(self, sample_per_epoch=6000, filePaths="", split="train", DA=False, pre_transform=None, transform=None, preprocessed_dir="",
        ...
        super(AHNCDSimul, self).__init__(None, None, pre_transform)
        ...
        self.change_classes = AHNCD_CHANGE_CLASSES
        self.sem_classes = AHNCD_SEM_CLASSES
...
class AHNCDCylinder(AHNCDSphere):
    def get(self, idx):
        if self._sample_per_epoch > 0:
            if self.fix_cyl:
                pair_correct = False
            ...
            while not pair_correct and idx<self.grid_regular_centers.shape[0]:
                ...
                try:
                    ...
                    pair_cylinders = Pair(pos=dataPC0_cyl.pos, pos_target=dataPC1_cyl.pos, sem_y=dataPC0_cyl.sem_y, sem_y_target=dataPC1_cyl.sem_y,
                                          ...
                                          full_rgb_target=full_dataPC1_cyl.rgb.clone(),
                                          full_sem_y=full_dataPC0_cyl.sem_y, full_sem_y_target=full_dataPC1_cyl.sem_y,
                                          full_inst_y=full_dataPC0_cyl.inst_y, full_inst_y_target=full_dataPC1_cyl.inst_y,
                                          full_change_y=full_dataPC0_cyl.change_y, full_change_y_target=full_dataPC1_cyl.change_y,
                                          idx=dataPC0_cyl.idx, idx_target=dataPC1_cyl.idx, area=area_sel, file_names=self.filesPC0[area_sel])
                    if self.DA:
...
class AHNDataset(BaseSiameseDataset): #AHNCDDataset AHNCDSimulDataset
    ...
    def __init__(self, dataset_opt):
        ...
        self.train_dataset = AHNCDCylinder(
        ...
        self.val_dataset = AHNCDCylinder(
        ...
        self.test_dataset = AHNCDCylinder(
    ...
    def get_tracker(self, wandb_log: bool, tensorboard_log: bool, full_pc=False, full_res=False):
        """Factory method for the tracker
            ...
            Returns:
                [BaseTracker] -- tracker
            """
        return ahniCDTracker(self, wandb_log=wandb_log, use_tensorboard=tensorboard_log,
